...
public class RaceControllerTests {
    ...
    public void testGetRaceById() throws Exception {
        this.mockMvc.perform(get("/api/races/532084630cf2c35bca3d288e").accept(MediaType.parseMediaType("application/json;charset=UTF-8"))).andDo(print()).andExpect(status().isOk());
    }

    @Test
    public void testGetRaceDataById() throws Exception {
        System.out.println("Make sure the id is valid!");
        this.mockMvc.perform(get("/api/races/532084630cf2c35bca3d288e/data").accept(MediaType.parseMediaType("application/json;charset=UTF-8"))).andDo(print()).andExpect(status().isOk());
    }
}
